...
export default class PlayerStats extends React.Component {
  ...
  componentDidMount() {
    return (
      fetch(
        `https://stats.nba.com/stats/commonallplayers/?leagueId=${nbaId}&season=${year}&isOnlyCurrentSeason=1`
      )
  ...
  renderRow(rowData) {
    ...
    const primaryColor = teamColors[rowData[10]]
      ? teamColors[rowData[10]].primary
      : colors.greyDarkest;
    const secondaryColor = teamColors[rowData[10]]
      ? teamColors[rowData[10]].secondary
      : colors.greyDarkest;
    return (
      <ListItem
        key={rowData[0]}
        ...
        leftAvatar={{
          rounded: true,
          source: {
            uri: `https://nba-players.herokuapp.com/players/${firstLast[1]}/${
              firstLast[0]
            }`
          },
          // medium: true,
