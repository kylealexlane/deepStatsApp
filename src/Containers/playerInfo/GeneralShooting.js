...
export default class GeneralShooting extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      ...
      headerStyle: {
        backgroundColor: params.playerTeamShort
          ? hexToRgbA(teamColors[params.playerTeamShort].primary, 1)
          : colors.greyDarkest,
  ...
  fetchNewData(season) {
    console.log(
      `https://stats.nba.com/stats/playerdashptshots/?perMode=PerGame&leagueId=00&season=${
        season[1]
      }&seasonType=Regular+Season&playerId=${
        this.props.navigation.state.params.playerId
      }&teamId=${
        season[3]
      }&outcome=&location=&month=0&seasonSegment=&dateFrom=&dateTo=&opponentTeamId=0&vsConference=&vsDivision=&gameSegment=&period=0&lastNGames=0`
    );
    return fetch(
      `https://stats.nba.com/stats/playerdashptshots/?perMode=PerGame&leagueId=00&season=${
        season[1]
  ...
  render() {
    ...
    if (state.tableDataOverall.length > 0) {
      topGeneralStats =
        state.tableDataOverall[state.tableDataOverall.length - 1];
    }
      ...
      <ScrollView style={styles.container} stickyHeaderIndices={[1]}>
        ...
        <View
          style={{
            ...
            borderBottomWidth: 0,
            borderBottomColor: this.props.navigation.state.params
              .playerTeamShort
              ? hexToRgbA(
                  teamColors[this.props.navigation.state.params.playerTeamShort]
                    .primary,
                  1
                )
              : colors.greyDarkest
        ...
        >
          ...
          >
              ...
              <View style={styles.selectorContainer}>
                ...
                >
                  <EntypoIcon
                    ...
                    color={
                      teamColors[
                        this.props.navigation.state.params.playerTeamShort
                      ].primary
                    }
                    onPress={() => {
            ...
            <View style={styles.displayContainer}>
              ...
              <Text style={styles.besideSelectorText}>
                {this.state.seasonSelected[7]}
              </Text>
            </View>
            <View style={styles.displayContainer}>
              <Text style={styles.besideSelectorSecondaryText}>TEAM</Text>
              <Text style={styles.besideSelectorText}>
                {this.state.seasonSelected[4]}
              </Text>
            </View>
          </View>
        </View>
        <View>
          ...
          >
            <View style={styles.displayContainer}>
              ...
              <Text style={styles.genStatsNumberText}>
                {(topGeneralStats[4] * 100).toFixed(1)}
              </Text>
            </View>
            ...
            <View style={styles.displayContainer}>
              ...
              <Text style={styles.genStatsNumberText}>
                {(topGeneralStats[5] * 100).toFixed(1)}
              </Text>
            </View>
            <VerticalSeperator style={{ height: 40 }} />
            <View style={styles.displayContainer}>
              ...
              <Text style={styles.genStatsNumberText}>
                {(topGeneralStats[10] * 100).toFixed(1)}
              </Text>
            </View>
            <VerticalSeperator style={{ height: 40 }} />
            <View style={styles.displayContainer}>
              ...
              <Text style={styles.genStatsNumberText}>
                {(topGeneralStats[13] * 100).toFixed(1)}
              </Text>
            </View>
          </View>
        </View>
        <GeneralTable
          ...
          errorMessage={
            this.state.errorMessage
              ? "Data not available prior to 2013-14 season"
              : ""
          }
          title={"GENERAL"}
          ...
          titleStyle={{
            backgroundColor: this.props.navigation.state.params.playerTeamShort
              ? hexToRgbA(
                  teamColors[this.props.navigation.state.params.playerTeamShort]
                    .primary,
                  1
...
const styles = StyleSheet.create({
  ...
  row: { height: 20, backgroundColor: colors.primaryBackground },
  secondaryRow: {
