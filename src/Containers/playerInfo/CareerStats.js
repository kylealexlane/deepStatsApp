...
export default class CareerStats extends React.Component {
  ...
  formatData(playerStats) {
    ...
    let careerStatsRows = [];
    const types = {
      CareerTotalsRegularSeason: "Regular Season",
      CareerTotalsPostSeason: "Post Season",
      CareerTotalsAllStarSeason: "All Star Season",
      CareerTotalsCollegeSeason: "College Season",
      CareerTotalsPreseason: "Pre Season"
    };
