...
export default class Standings extends React.Component {
  ...
  fetchStandings(tabSelected) {
    ...
    return (
      fetch(`https://ca.global.nba.com/stats2/season/${urlKey}.json?locale=en`)
        ...
        .then(responseJson => {
          ...
          if (
            responseJson.payload.standingGroups &&
            responseJson.payload.standingGroups.length > 0
          ) {
            ...
            teams.forEach(obj => {
              ...
              tabSelected === "Division"
                ? arrayOfDivisions.push(arrayOfTeamsInGroup)
                : arrayOfConferences.push(arrayOfTeamsInGroup);
            });
            this.setState({
              arrayOfConferences,
              arrayOfDivisions,
    ...
    return (
      <View>
        <GeneralTable
          ...
          headerStyle={{
            backgroundColor: colorLuminance(colors.mainAccent, -0.4),
            height: 30
          }}
        />
        <GeneralTable
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.baseBackground }}>
        ...
        <ScrollView style={styles.container}>
          {this.state.loading
            ...
            : (this.state.arrayOfConferences.length > 0 ||
                this.state.arrayOfDivisions.length > 0) && (
                <View>
...
const styles = StyleSheet.create({
  ...
  tabHeaderView: {
    ...
    alignItems: "center",
    shadowRadius: 5, //need to fix the shadow
