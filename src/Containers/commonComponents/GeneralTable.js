...
export default class GeneralTable extends React.Component {
  ...
  render() {
    ...
    const firstColumnHeader = this.props.headerRow
      ? this.props.headerRow.slice(0, 1)
      : [];
    ...
    return (
      <View style={this.props.containerStyle}>
        <View style={[styles.titleContainer, this.props.titleStyle]}>
          {this.props.showHideIcon && this.state.hideTable ? (
            ...
            <View style={styles.tableContainer}>
              <View style={{ width: firstColWidth[0] ? firstColWidth[0] : 0 }}>
                <View>
                  <Table
                    borderStyle={{
                      borderColor: this.props.headerStyle.backgroundColor
                        ? this.props.headerStyle.backgroundColor
                        : "transparent"
                    }}
                  >
