...
export default class GameScore extends React.Component {
  ...
  renderBottomText(team, boxscore) {
    ...
    return (
      <Text style={styles.recordText}>
        {team.matchup.wins}-{team.matchup.losses}
      </Text>
    );
    // }
  }
        ...
        <View>
          <Text>
            <Text style={styles.timeText}>
              {moment(date.toString()).format("h:mm a")}
            </Text>
          </Text>
      ...
      <View style={styles.columnContainer}>
        ...
        <View style={styles.graphRow}>
          <Text
            style={[
              styles.scoresText,
              leader === "home" && styles.boldScoreText
            ]}
          >
            {boxscore.homeScore}
          </Text>
          ...
          <Text
            style={[
              styles.scoresText,
              leader === "away" && styles.boldScoreText
            ]}
          >
            {boxscore.awayScore}
          </Text>
        ...
        {this.props.fromGameInfo ? null : (
          <View>
            <View style={styles.graphRow}>
              <Text
                style={[
                  styles.otherStatsText,
                  fgpctLeader === "home" && styles.otherStatsTextBold
                ]}
              >
                {homeTeam.score.fgpct.toFixed(1)}
              </Text>
              <Text style={[styles.scoresMiddleText]}> FG% </Text>
              <Text
                style={[
                  styles.otherStatsText,
                  fgpctLeader === "away" && styles.otherStatsTextBold
                ]}
              >
                {awayTeam.score.fgpct.toFixed(1)}
              </Text>
            </View>
            <View style={styles.graphRow}>
              <Text
                style={[
                  styles.otherStatsText,
                  asstLeader === "home" && styles.otherStatsTextBold
                ]}
              >
                {homeTeam.score.assists}
              </Text>
              <Text style={[styles.scoresMiddleText]}> ASST </Text>
              <Text
                style={[
                  styles.otherStatsText,
                  asstLeader === "away" && styles.otherStatsTextBold
                ]}
              >
                {awayTeam.score.assists}
              </Text>
            </View>
            <View style={styles.graphRow}>
              <Text
                style={[
                  styles.otherStatsText,
                  rebLeader === "home" && styles.otherStatsTextBold
                ]}
              >
                {homeTeam.score.rebs}
              </Text>
              ...
              <Text
                style={[
                  styles.otherStatsText,
                  rebLeader === "away" && styles.otherStatsTextBold
                ]}
              >
                {awayTeam.score.rebs}
              </Text>
  ...
  render() {
    ...
    return (
      <View
        style={[
          leader === "home" && styles.shadowLeft,
          leader === "away" && styles.shadowRight,
          this.props.fromGameInfo && { shadowOpacity: 0 }
        ]}
      >
        <TouchableOpacity
          style={[
        ...
        >
          <View style={styles.columnContainer}>
            <SVGImage
              ...
              source={{
                uri: `https://ca.global.nba.com/media/img/teams/00/logos/${
          ...
          <View>{this.renderMiddleView(this.props.item, leader)}</View>
          <View style={styles.columnContainer}>
            <SVGImage
              style={styles.teamLogo}
              source={{
                uri: `https://ca.global.nba.com/media/img/teams/00/logos/${
                  awayTeam.profile.abbr
                }_logo.svg`
              }}
            />
